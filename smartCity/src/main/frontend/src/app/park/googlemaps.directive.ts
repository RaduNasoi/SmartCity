...
export class DirectionsMapDirective {
  ...
  // ];
  public minDestination = { id: null, latitude: null, longitude: null }
              ...
              directionsService.route({
                ...
                if (status === 'OK') {
                  ...
                  if(min > response.routes[0].legs[0].distance.value && nearestDestination.freeSpots > 0 )
                  {
                    ...
                    this.minDestination = nearestDestination;
                ...
                localStorage.setItem('nearestDestination', JSON.stringify(this.minDestination));
              });
